...
// router.post('/signup', authLimiter, authController.signup); // Only for initial admin setup - not implemented
router.post('/login', authLimiter, authController.login);
router.post('/logout', authController.logout);
router.post('/request-password-reset', authLimiter, authController.requestPasswordReset);
// router.get('/reset-password/:token', authController.redirectToResetPage); // Redirect to frontend - not implemented
