...
// router.get('/forums', teacherController.getTeacherForums); - REMOVED
// router.get('/course/:courseId/forums', teacherController.getCourseForums); - REMOVED
// router.post('/course/:courseId/forum', teacherController.createCourseForum); - REMOVED
// router.get('/forum/:forumId', teacherController.getForumDiscussion); - REMOVED
// router.post('/forum/:forumId/reply', teacherController.postForumReply); - REMOVED
