...
// Forum controller imports removed
// const discussionController = require('../controllers/discussionController'); - REMOVED
// const forumController = require('../controllers/forumController'); - REMOVED
...
// router.get('/discussions', discussionController.getAllDiscussions); - REMOVED
// router.delete('/discussion/:id', discussionController.removeDiscussion); - REMOVED

// Admin Forum Routes removed
// router.get('/forums', forumController.getAdminForums); - REMOVED
// router.get('/forums/flagged', forumController.getFlaggedContent); - REMOVED
// router.get('/forums/statistics', forumController.getForumStatistics); - REMOVED
// router.get('/forums/recent-activity', forumController.getRecentActivity); - REMOVED
// router.get('/forum-categories', forumController.getForumCategories); - REMOVED
// router.post('/forum-category', ...) - REMOVED
// router.get('/forum/:forumId', forumController.getForumWithReplies); - REMOVED
// router.patch('/forum/:forumId/status', forumController.updateForumStatus); - REMOVED
// router.post('/forum/:forumId/reply', forumController.postForumReply); - REMOVED
// router.delete('/forum/:forumId', forumController.deleteForum); - REMOVED
// router.delete('/forum/reply/:replyId', forumController.deleteForumReply); - REMOVED
// router.post('/forums/dismiss-flags', ...) - REMOVED

// Link to centralized discussion system removed
// router.use('/discussions', require('../routes/discussionRoutes')); - REMOVED
