...
const EnhancedTeacherVideoPlayer = ({ videoUrl, videoType, videoLink, title }) => {
  ...
  // Handle video time update (only for upload videos)
    ...
    <>
      <Paper elevation={2} sx={{ borderRadius: 2, overflow: 'hidden' }}>
        ...
        {videoInfo.embedType === 'youtube' || videoInfo.embedType === 'vimeo' ? (
          <Box sx={{ p: 1, bgcolor: 'secondary.main', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
...
export default EnhancedTeacherVideoPlayer;