                    ...
                    <Stack spacing={1}>
                      ...
                      {section.courses && section.courses.length > 0 ? (
                        <GroupChatButton 
                          ...
                          fullWidth
                          onClick={() => {
                            console.log('[TeacherSections] Group Chat clicked, section data:', section);
                            console.log('[TeacherSections] Section courses:', section.courses);
                            const course = section.courses[0];
                            const chatContext = {
                              courseId: course._id || course,
                              sectionId: section._id,
                              courseTitle: course.title || course.courseTitle || section.name
                            };
                            console.log('[TeacherSections] Setting chatContext:', chatContext);
