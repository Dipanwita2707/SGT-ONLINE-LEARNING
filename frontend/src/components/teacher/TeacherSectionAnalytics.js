...
const TeacherSectionAnalytics = ({ user, token }) => {
  ...
  // Chart data for student progress over time
  const studentProgressData = {
    labels: sectionAnalytics.performanceData?.weeklyProgress?.labels || [],
    datasets: [
      {
        label: 'Weekly Progress (%)',
        data: sectionAnalytics.performanceData?.weeklyProgress?.data || [],
  ...
  const quizScoresData = {
    labels: sectionAnalytics.performanceData.labels || [],
    datasets: [
      {
  ...
  const engagementData = {
    ...
    datasets: [
      {
        data: [
          sectionAnalytics.sectionDetails.students?.filter(s => s.engagementLevel === 'high').length || 0,
          sectionAnalytics.sectionDetails.students?.filter(s => s.engagementLevel === 'medium').length || 0,
          sectionAnalytics.sectionDetails.students?.filter(s => s.engagementLevel === 'low').length || 0,
        ],
        backgroundColor: [
          'rgba(75, 192, 192, 0.6)',
          'rgba(255, 206, 86, 0.6)',
                        ...
                        <Grid container spacing={2}>
                          <Grid item xs={6}>
                            ...
                            <Typography variant="body1">
                              {sectionAnalytics.sectionDetails.sectionName}
                            </Typography>
                          </Grid>
                          <Grid item xs={6}>
                            <Typography variant="body2" color="text.secondary">
                            ...
                            <Typography variant="body1">
                              {sectionAnalytics.sectionDetails.courseName}
                            </Typography>
                          </Grid>
                          <Grid item xs={6}>
                            <Typography variant="body2" color="text.secondary">
                            ...
                            <Typography variant="body1">
                              {sectionAnalytics.sectionDetails.studentCount}
                            </Typography>
                          </Grid>
                          <Grid item xs={6}>
                            <Typography variant="body2" color="text.secondary">
                            ...
                            <Typography variant="body1">
                              {sectionAnalytics.sectionDetails.videoCount}
                            </Typography>
                          </Grid>
                        </Grid>
                      </CardContent>
                      ...
                      <CardContent>
                        ...
                        <TableContainer>
                          <Table>
                            ...
                            <TableBody>
                              {sectionAnalytics.sectionDetails.students?.map((student) => (
