...
const HODAnalytics = () => {
  ...
  const [chatContext, setChatContext] = useState({ course: null, section: null });
                  ...
                  <Table>
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell><strong>Group Chat</strong></TableCell>
                          ...
                          <TableCell>
                            {section.courses && section.courses.length > 0 ? (
                              <GroupChatButton onClick={() => {
                                console.log('[HOD Analytics] Section data for chat:', section);
                                const chatContext = {
                                  courseId: section.primaryCourseId || section.courses[0],
                                  sectionId: section._id || section.sectionId,
                                  courseTitle: section.primaryCourseTitle || section.courseDetails?.[0]?.title || section.name
                                };
                                console.log('[HOD Analytics] Setting chat context:', chatContext);
